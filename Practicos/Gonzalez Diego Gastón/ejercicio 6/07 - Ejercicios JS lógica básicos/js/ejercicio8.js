...
const largo = parseFloat(prompt("Ingrese el largo de la habitación (en metros):"));
const ancho = parseFloat(prompt("Ingrese el ancho de la habitación (en metros):"));
const altura = parseFloat(prompt("Ingrese la altura de las paredes (en metros):"));
const precioPorLitro = parseFloat(prompt("Ingrese el precio de un litro de pintura:"));
...
const resumen = alert(`Resumen del presupuesto:\nPerímetro de la habitación: ${perimetro} metros\nMetros cuadrados de pared: ${metrosCuadradosPared} m2\nLitros necesarios: ${litrosNecesarios.toFixed(2)}\nCosto total de pintura: $${costoTotal.toFixed(2)}`);
console.log(`El usuario quiere ver el resumen del presupuesto: ${quiereVerResumen}`);