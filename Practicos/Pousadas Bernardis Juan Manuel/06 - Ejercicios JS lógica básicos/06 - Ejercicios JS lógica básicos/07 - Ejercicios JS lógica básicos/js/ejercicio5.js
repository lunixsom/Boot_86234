...
let precioFinalConDescuento = precioFinal - montoDescontado;

console.log(`El precio original es: $${precioProducto} * 1.21`);
console.log(`El precio con IVA es: $${precioConIVA.toFixed(2)}`);
console.log(`El precio final es: $${precioFinal.toFixed(2)}`);
console.log(`El precio final con descuento es: $${precioFinalConDescuento.toFixed(2)}\n\n`);

console.log(`El precio final sin descuento es: $${precioFinal.toFixed(2)}`);
console.log(`El descuento es de: $${montoDescontado.toFixed(2)}`);
console.log(`El precio final es: $${precioFinalConDescuento.toFixed(2)}`);