...
let habitacionLargo = parseFloat(prompt("El largo de la habitación: "));
let habitacionAncho = parseFloat(prompt("El ancho de la habitación: "));
let paredesAltura = parseFloat(prompt("La altura de las paredes: "));
let precioLitro = parseFloat(prompt("El precio de un litro de pintura: "));

const rendimientoPorLitro = 6;

let quiereVerResumen = confirm("¿Deseás ver el resumen del presupuesto?");
let perimetro = 2 * (habitacionAncho + habitacionLargo);
let metrosCuadrados = perimetro * paredesAltura;
let litrosNecesarios = metrosCuadrados / rendimientoPorLitro;
let = costoTotal = litrosNecesarios * precioLitro;

console.log(`¿Quiere ver el resumen? ${quiereVerResumen}`)
console.log(`Perimetro de la habitacion: ${perimetro.toFixed(2)}`);
console.log(`Metros cuadrados de pared: ${metrosCuadrados.toFixed(2)}`);
