...
let ancho = 4;
let altura = 2.5;
let precioPorLitro = 5000;
let rendimientoPorLitro = 6;

let perimetro = 2 * (largo + ancho);
let m2 = perimetro * altura;
let litrosNecesarios = m2 / rendimientoPorLitro;
let costoTotal = litrosNecesarios * precioPorLitro;

console.log(`El perímetro de la habitación: ${perimetro}`);
console.log(`Metros cuadrados de la pared: ${m2}`);
