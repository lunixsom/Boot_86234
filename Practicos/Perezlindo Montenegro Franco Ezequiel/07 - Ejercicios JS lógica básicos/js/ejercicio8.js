...
let ancho = 2;
let altura = 3;
let precioPorLitro = 6000
let rendimientoPorLitro = 6;

let perímetro = 2 * (largo + ancho);
let metrosCuadradosPared = perímetro * altura;
let litrosNecesarios = metrosCuadradosPared / rendimientoPorLitro;
let costoTotal = litrosNecesarios * precioPorLitro;

console.log(`Perímetro de la habitación: ${perímetro} metros`);
...
alert(
  `Perímetro de la habitación: ${perímetro} metros\n` +
