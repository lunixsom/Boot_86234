...
*/
let ingresoMensual = 2000000;
let gastoAlquiler = 450000;
let gastoComida = 300000;
let gastoTransporte = 55000;
let gastoServicios = 36000;
let gastoEntretenimiento = 300000;
...
let porcentajeGastado = ((totalGastos / ingresoMensual) * 100).toFixed(2);
...
alert(
  ...
  "Porcentaje gastado: " + porcentajeGastado + "%"
);