...
let tareas = ["Estudiar DOM", "Practicar eventos", "Hacer el proyecto", "Repasar array methods"];
const ulHTML = document.querySelector("#lista");
...
ulHTML.firstElementChild.remove();

const texto = "Repasar HTML semántico";
const liNuevo = document.createElement("li");
liNuevo.textContent = texto;
ulHTML.insertBefore(liNuevo, ulHTML.firstElementChild);
