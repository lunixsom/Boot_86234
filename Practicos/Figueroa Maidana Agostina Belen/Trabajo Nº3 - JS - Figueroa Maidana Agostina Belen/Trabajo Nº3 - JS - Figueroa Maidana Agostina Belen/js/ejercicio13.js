...
console.log(areaCirculo(valorCirculo));
...
console.log(saludarFn(nombre));

console.log(sumarFn(num1, num2));

console.log(esMayorDeEdadFn(edad));

console.log(areaCirculoFn(valorCirculo))