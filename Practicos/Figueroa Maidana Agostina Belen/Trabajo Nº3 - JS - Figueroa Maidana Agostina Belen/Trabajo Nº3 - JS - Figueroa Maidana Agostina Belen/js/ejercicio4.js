...
for (let i = 0; i < temperaturas.length; i++) {
  ...
  console.log(`Día ${i + 1}: ${temperaturas[i]}ºC`);

}

console.log(`La temperatura más alta es ${Math.max(...temperaturas)}`);

console.log(`La temperatura más baja es ${Math.min(...temperaturas)}`);