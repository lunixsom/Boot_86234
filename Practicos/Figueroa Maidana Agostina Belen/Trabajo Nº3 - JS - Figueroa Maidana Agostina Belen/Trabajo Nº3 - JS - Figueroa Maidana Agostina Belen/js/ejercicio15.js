...
function contarOcurrencias(array, elemento) {
  ...
  for(let ocurrencia in array) {

    if (array[ocurrencia] === elemento){
      ocurrencias++;
    }
...
const texto = "JavaScript es un lenguaje de programación muy utilizado";

console.log(contarLetras(texto, "a"));
console.log(contarLetras(texto, "e"));
console.log(contarLetras(texto, "z"));