...
const ingresoMensual = +prompt("Introduzca su ingreso mensual:");
const gastoAlquiler = +prompt("¿Cuál es su gasto en alquiler?:");
const gastoComida = +prompt("¿Cuál es su gasto en comida?:");
const gastoTransporte = +prompt("¿Cuál es su gasto en transporte?:");
const gastoServicios = +prompt("¿Cuál es su gasto en servicios?:");
const gastoEntretenimiento = +prompt("¿Cuál es su gasto en entretenimiento?:");

const totalGastoMensual = gastoAlquiler + gastoComida + gastoTransporte + gastoServicios + gastoEntretenimiento;
const restanteMensual = ingresoMensual - totalGastoMensual;
const porcentajeGastado = (totalGastoMensual / ingresoMensual) * 100;
...
console.log(`Total de gastos: $${totalGastoMensual.toFixed(2)}`);
console.log(`Dinero restante: $${restanteMensual.toFixed(2)}`);
...
Total de gastos: $${totalGastoMensual.toFixed(2)}
Dinero restante: $${restanteMensual.toFixed(2)}
