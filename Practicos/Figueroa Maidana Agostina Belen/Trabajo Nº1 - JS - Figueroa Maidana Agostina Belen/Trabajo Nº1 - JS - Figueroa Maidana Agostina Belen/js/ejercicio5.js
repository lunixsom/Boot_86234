...
const precioProducto = 1560;
const iva = 0.21;
const ganancia = 0.4;
const descuento = 0.10;

const precioConIVA = precioProducto * (1 + iva);
const montoGanancia = precioConIVA * ganancia;
const precioFinal = precioConIVA + montoGanancia;
const descuentoRealizado = precioFinal * descuento;
const precioConDescuento = precioFinal - descuentoRealizado;
...
console.log(`El descuento es: $${descuentoRealizado.toFixed(2)}`);
