...
const precioProductoIva = 1000 * 1.21;

const ganancia = 0.4;

const precioFinal = precioProductoIva + precioProductoIva * ganancia;
console.log(`El precio original es de: $${precioProducto}`);

console.log(`El precio con IVA es de: $${precioProductoIva}`);

console.log(`El precio final con el IVA y la ganancia sumada es de: $${precioFinal} `);
const descuento = 0.1;

const precioDescuento =  precioFinal * descuento;

const precioDesc = precioDescuento.toFixed(2)

console.log(`El descuento total es de: $${precioDesc}`)

const precioFinalDescuento = precioFinal - (precioFinal * descuento);

const precioFinalDesc = precioFinalDescuento.toFixed(2)

console.log(`El precio final con descuento del 10% es de: $${precioFinalDesc}`)