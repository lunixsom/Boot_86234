...
const passwordConfirm = prompt("Confirme su contraseña: ");
const aceptaTerminos = confirm("¿Acepta los términos y condiciones? (Aceptar = Sí, Cancelar = No)");

const formularioValido = nombre !== "" && email.includes("@") && password === passwordConfirm && aceptaTerminos;
