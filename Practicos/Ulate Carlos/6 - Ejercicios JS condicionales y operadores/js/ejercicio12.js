...
const lado1 = +prompt("Ingrese el valor del primer lado: ");
const lado2 = +prompt("Ingrese el valor del segundo lado: ");
const lado3 = +prompt("Ingrese el valor del tercer lado: ");
