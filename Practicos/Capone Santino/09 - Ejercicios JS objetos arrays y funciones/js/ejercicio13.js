...
// ==========================================
// Parte 1: Funciones tradicionales (declarativas)
// ==========================================
...
// Llamadas a las funciones tradicionales
...
console.log(saludarFn("Sofía")); // Hola, Sofía!
console.log(sumarFn(10, 5)); // 15
console.log(esMayorDeEdadFn(18)); // true
console.log(areaCirculoFn(5)); // 78.53981633974483
