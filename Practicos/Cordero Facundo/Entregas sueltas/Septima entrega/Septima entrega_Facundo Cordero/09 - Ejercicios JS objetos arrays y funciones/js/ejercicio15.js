...
// ==========================================
function contarLetrasEnTexto(texto, letraAbuscar) {
    const textoMin = texto.toLowerCase();
    const letraMin = letraAbuscar.toLowerCase();
    return textoMin.split(letraMin).length - 1;
}

const miTextoLargo = "JavaScript es un lenguaje fascinante, ideal para crear aplicaciones web.";

console.log("Texto de prueba:", miTextoLargo);
console.log(`Ocurrencias de la letra "a":`, contarLetrasEnTexto(miTextoLargo, "a"));
console.log(`Ocurrencias de la letra "e":`, contarLetrasEnTexto(miTextoLargo, "e"));