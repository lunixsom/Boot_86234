...
function marcarComoError(input, elementoError, mensaje) {
...
function marcarComoValido(input, elementoError) {
...
function validarNombre() {
    ...
    if (valor === '') {
        marcarComoError(inputNombre, errorNombre, 'El nombre no puede estar vacío');
        return false;
    }
    if (valor.length < 3) {
        marcarComoError(inputNombre, errorNombre, 'El nombre debe tener al menos 3 caracteres');
        return false;
    }

    marcarComoValido(inputNombre, errorNombre);
    return true;
}
...
function validarEmail() {
    ...
    if (valor === '') {
        marcarComoError(inputEmail, errorEmail, 'El email no puede estar vacío');
        return false;
    }
    if (!regexEmail.test(valor)) {
        marcarComoError(inputEmail, errorEmail, 'El email debe incluir "@" y "."');
        return false;
    }

    marcarComoValido(inputEmail, errorEmail);
    return true;
}
...
function validarPassword() {
    ...
    if (valor === '') {
        marcarComoError(inputPassword, errorPassword, 'La contraseña no puede estar vacía');
        return false;
    }
    if (valor.length < 8) {
        marcarComoError(inputPassword, errorPassword, 'La contraseña debe tener al menos 8 caracteres');
        return false;
    }

    marcarComoValido(inputPassword, errorPassword);
    return true;
}
