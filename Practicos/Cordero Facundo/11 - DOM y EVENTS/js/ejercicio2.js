...
console.log("--- Paso 1: Creando lista inicial ---");
...
console.log("--- Paso 2: Eliminando el primer elemento ---");

const primerElemento = listaUl.firstElementChild;

if (primerElemento) {
    primerElemento.remove();
}

console.log("--- Paso 3: Insertando nuevo elemento al principio ---");

const liSemantico = document.createElement('li');

liSemantico.textContent = "Repasar HTML semántico";

const referenciaActual = listaUl.firstElementChild;

listaUl.insertBefore(liSemantico, referenciaActual);
