 ...
 * ¿Qué observás? Explicalo con un comentario:
 *
 * Al ejecutar classList.toggle dos veces seguidas sobre el mismo elemento con la misma clase,
 * el elemento vuelve a su estado original. Es como un interruptor de luz: si lo pulsas dos veces,
 * la luz se enciende y se apaga (o viceversa), quedando como estaba al principio.
 * En este caso, la tarjeta-2 no se ocultará en el resultado final.
 */