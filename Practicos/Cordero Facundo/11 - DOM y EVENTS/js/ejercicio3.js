...
console.log("--- Paso 1: Lectura de atributos data-* ---");
...
divResultado.textContent = `Hay ${productosElectronica.length} productos de electrónica`;
...
productosArray.forEach((producto) => {
    const precioActual = Number(producto.dataset.precio);
