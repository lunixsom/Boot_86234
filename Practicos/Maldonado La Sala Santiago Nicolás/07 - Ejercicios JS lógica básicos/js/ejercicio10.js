...
let ingresoMensual = Number (prompt("Declara tu ingreso mensual:"));
let gastoAlquiler = Number (prompt("Cuanto gastas en alquiler:" ));
let gastoComida = Number (prompt("Cuanto gastas en comida:"));
let gastoTransporte = Number (prompt("Cuanto gastas en transporte:"));
let gastoServicios = Number (prompt("Cuanto gastas en servicios:"));
let gastoEntretenimiento = Number (prompt("Cuanto gastas en entretenimiento"));
let quiereVerResumen = confirm("¿Deseás ver el resumen de tu presupuesto mensual?");

const totalGastos = (gastoAlquiler + gastoComida + gastoEntretenimiento + gastoTransporte + gastoServicios);
const restoIngreso = (ingresoMensual - totalGastos);
const porcentajeGastado = ((totalGastos / ingresoMensual) * 100);

console.log(`Ingreso mensual: $${ingresoMensual}`);
console.log(`Total de gastos: $${totalGastos}`);
console.log(`Dinero restante: $${restoIngreso}`);
console.log(`Porcentaje gastado: ${porcentajeGastado.toFixed(2)}%`);
console.log(`¿El usuario quiso ver el resumen?: ${quiereVerResumen}`);

alert (`Resumen de tus finanzas:
Ingreso mensual: $${ingresoMensual}
Total de gastos: $${totalGastos}
Dinero restante: $${restoIngreso}
