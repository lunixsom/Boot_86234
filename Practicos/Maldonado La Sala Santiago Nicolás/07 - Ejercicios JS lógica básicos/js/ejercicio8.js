...
let largoHab = Number(prompt("Ingresa el largo de la habitación:"));
let anchoHab = Number(prompt("Ingresa el ancho de la habitación:"));
let alturaPared = Number(prompt("Ingresa el alto de las paredes:"));
let precioLitroPintura = Number(prompt("Ingresa el precio del litro de pintura:"));
let quiereVerResumen = confirm ("Deseas ver el resumen del presupuesto?");
const rendimientoPorLitro = 6;

const perimetro = (2 *(largoHab + anchoHab));
const metrosCuadradosPared = (perimetro * alturaPared);
const litrosNecesarios = (metrosCuadradosPared / rendimientoPorLitro);
const costoTotal = (litrosNecesarios * precioLitroPintura);

console.log(`Perimetro de la habitación: ${perimetro.toFixed(2)} metros`);
console.log(`Metros cuadrados de pared: ${metrosCuadradosPared.toFixed(2)} m2`);
console.log(`Litros necesarios: ${litrosNecesarios.toFixed(2)}l`);
console.log(`Costo total de pintura: $${costoTotal.toFixed(2)}`);


alert (`Perimetro de la habitación: ${perimetro.toFixed(2)} metros`);
alert (`Metros cuadrados de pared: ${metrosCuadradosPared.toFixed(2)} m2`);
alert (`Litros necesarios: ${litrosNecesarios.toFixed(2)}l`);
alert (`Costo total de pintura $${costoTotal.toFixed(2)}`);
