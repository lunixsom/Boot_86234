...
if (edad < 13){
  ...
  console.log(`Tu edad es ${edad}, tu categoria es: Nińo/a`);

} else if (edad >= 13 && edad <= 17 ){

  console.log(`Tu edad es ${edad}, tu categoria es: Adolescente`);

} else if (edad >= 18 && edad <= 64 ){

  console.log(`Tu edad es ${edad}, tu categoria es: adulto/a`);

} else{
  
  console.log(`Tu edad es ${edad}, tu categoria es: Adulto/a Mayor`);
