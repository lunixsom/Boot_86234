...
const categoria = String(prompt("Ingresa el tipo de categoria del producto, las categoria disponibles son electronica, ropa y alimentos:")).toLowerCase();
const precioOriginal = Number (prompt("Ingresa un valor"));
let descuento;
