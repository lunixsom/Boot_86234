...
console.log(numeros); // confirma que el original no cambió
...
console.log(contarLetraEnTexto("programacion en javascript", "a"));
console.log(contarLetraEnTexto("programacion en javascript", "r"));