...
tareas.forEach(tarea => {
  const li = document.createElement("li")  // a) crear el elemento
  li.textContent = tarea                    // b) asignar contenido
  lista.appendChild(li)                     // c) agregarlo al padre
})

lista.firstElementChild.remove()

lista.insertAdjacentHTML("afterbegin", "<li>Repasar HTML semántico</li>")