...
//Creo variables
const precioProducto = 14000;
const ganancia = 1.4;
const descuento = 0.1; 
const precioConIVA = precioProducto * 1.21;
const precioFinal = precioConIVA * ganancia;
const precioFinalConDescuento = precioFinal * 0.90 ;
...
console.log("El descuento es de " + precioFinal * descuento);
