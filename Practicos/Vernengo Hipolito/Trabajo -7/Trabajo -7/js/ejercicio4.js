...
const mayorTemperatura = Math.max(...temperaturas);
const menorTemperatura = Math.min(...temperaturas);

console.log(`La menor temperatura es de ${menorTemperatura}°C`);
console.log(`La mayor temperatura es de ${mayorTemperatura}°C`);
