...
console.log("Hola," , saludar("Sofía"));
console.log(sumar(5,5));
console.log(esMayorDeEdad(18));
console.log(areaCirculo(5));

const saludarFn = (nombre) => nombre;

const sumarFn = (a,b) => a + b;

const esMayorDeEdadFn = (valor) =>{
    if(valor >= 18){
        return true
    } else return false;
};
...
console.log("Hola,", saludarFn("Sofía"));
console.log(sumarFn(5,5));
console.log(esMayorDeEdadFn(17));
