...
const botonesHTML = document.querySelectorAll(".tab-btn");
const contenidoHTML = document.querySelectorAll(".tab-contenido");

const botonesConversion = [...botonesHTML];
const contenidoConversion = [...contenidoHTML];


botonesConversion.forEach((boton) => {
    ...
    boton.addEventListener("click", () => {
        ...
        contenidoConversion.forEach((contenido) => {
        ...
        const contenido = document.querySelector(`#${tab}`);
