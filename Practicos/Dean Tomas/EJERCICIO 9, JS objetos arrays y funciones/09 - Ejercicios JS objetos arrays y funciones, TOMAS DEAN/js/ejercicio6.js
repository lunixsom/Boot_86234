...
const elementosExtraidos = letras.slice(2, 5);
console.log("Extraído:", elementosExtraidos);

console.log("Original intacto:", letras);

const elementosEliminados = letras.splice(3, 2);
console.log("Eliminado:", elementosEliminados);
