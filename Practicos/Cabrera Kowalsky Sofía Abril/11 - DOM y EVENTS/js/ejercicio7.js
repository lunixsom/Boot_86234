...
renderLista(paises);
contador.textContent = paises.length + " paises";


buscador.addEventListener("input", function (){
let busqueda = buscador.value;

let resultados = paises.filter(function(pais){
  return pais.toLowerCase().includes(busqueda.toLowerCase());
});
...
contador.textContent =  resultados.length + " países"
}
