...
const electronica = arrayProductos.filter(producto => producto.dataset.categoria === "electronica");

const resultado = document.querySelector("#resultado");
resultado.textContent = `Hay ${electronica.length} productos de electronica`;
