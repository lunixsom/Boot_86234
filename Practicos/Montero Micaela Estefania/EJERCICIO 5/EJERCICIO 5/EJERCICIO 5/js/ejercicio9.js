...
const cantidadDeKilometros = 445;
const kilometrosRecorrido = 5;
const precioCombustible = 2000;
const personasViajando = 5;

const litrosNecesarios = cantidadDeKilometros / kilometrosRecorrido;
const dineroCombustible = precioCombustible * litrosNecesarios;
const gastoPorPersona = dineroCombustible / personasViajando;

console.log(`Kilómetros del viaje: ${cantidadDeKilometros} km`);
console.log(`Rendimiento del vehículo: ${kilometrosRecorrido} km por litro`);
console.log(`Litros necesarios: ${litrosNecesarios.toFixed(2)}}`);
console.log(`Costo total del combustible: $${dineroCombustible}`);
console.log(`Costo por persona: $${gastoPorPersona.toFixed(2)}}`);

alert(`Litros necesarios: ${litrosNecesarios}\nCosto total: $${dineroCombustible}\nCosto por persona: $${gastoPorPersona}`);