...
titulo.textContent = 'Equipo de trabajo'; // 1

const description = document.querySelector('#descripcion');
description.innerHTML = 'Conocé a nuestro equipo. <strong>Somos 3 integrantes.</strong>'; // 2

const tarjeta1 = document.querySelector('#tarjeta-1');
tarjeta1.classList.add('destacado'); // 3

const tarjeta3 = document.querySelector('#tarjeta-3');
tarjeta3.classList.add('inactivo'); // 4
...
tarjeta2.classList.toggle('oculto'); // 6 - la clase se agrega en el primer toggle y se quita en el segundo, así que la tarjeta-2 queda exactamente igual que al principio
