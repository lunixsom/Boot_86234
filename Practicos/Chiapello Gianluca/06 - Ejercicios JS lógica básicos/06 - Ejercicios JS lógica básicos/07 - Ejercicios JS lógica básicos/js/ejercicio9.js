...
let kilometros = 300;
let rendimientoPorLitro = 12;
let precioPorLitro = 1100; //Costo total / Litros necesarios
let personas = 4; // Costo total / Costo por persona

let litrosNecesarios = kilometros / rendimientoPorLitro;
...
console.log(`Rendimiento del vehículo: ${rendimientoPorLitro} km por litro`);
console.log(`Litros necesarios: ${litrosNecesarios.toFixed(2)}`);
console.log(`Costo total del combustible: $${costoTotal}`);
