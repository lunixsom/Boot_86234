...
const extraído = letras.slice(2, 5);
console.log("Extraído:", extraído); // 1.

console.log("Original intacto:", letras); // 2.

const eliminado = letras.splice(3, 2);
console.log("Eliminado:", eliminado); // 3.

console.log("Array Resultante:", letras); // 4.
